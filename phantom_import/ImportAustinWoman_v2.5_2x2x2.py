...
trunk_mask = {'x': range(0, model_trunk.shape[0]),
...
AustinWoman.cleanup_3d_model(model_type='trunk', z_max=1300, bad_indices=[259])

# display the 3d model
AustinWoman.show_3d_model('trunk', show_endpoints=True)
