...
# scale the model down to a resolution of ~1mm
voxel_data = voxel_data[::2, ::2, ::2]
...
# Set the name
vm.name = 'Alvar_lowres'
vm.description = 'Alvar v16, downsampled for illustration, resolution: %2.2fmm x %2.2fmm x %2.2fmm' % (voxel_size[0],
                                                                                                       voxel_size[1],
                                                                                                       voxel_size[2])
...
(model_trunk, trunk_mask) = importer.calculate_trunk_model(vm, model_type='complete', z_start=880, z_end=1420)
